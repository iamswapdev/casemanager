      ...
      <div class="col-lg-12">
        <div class="hpanel">
          ...
          <div class="tab-content">
					...
					<div class="col-lg-12 panel-body tab-panel">
						<form action="updateadjuster" method="post" class="form-horizontal">
							...
							<div class="form-group col-md-12">
								...
								<div class="col-md-6">
									<select class="form-control m-b" id="adjusterId" name="adjusterId">
            ...
            <form action="updateadjuster" method="post" class="form-horizontal" style=" <?php if($display_form != 1){ ?> display: none; <?php }?>">
