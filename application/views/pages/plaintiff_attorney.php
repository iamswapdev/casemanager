				...
				<div class="panel-body tab-panel">
					...
					<form method="get" class="form-horizontal">
						...
						<div class="form-group form-horizontal col-sm-12">
							...
							<div class="col-sm-2">
								<input type="text" placeholder="Ex.11111" class="form-control input-sm">
						...
						<div class="form-group form-horizontal col-sm-12">
							...
							<div class="col-sm-2">
								<input type="text" placeholder="Ex.abc@pqr.com" class="form-control input-sm">
							</div>
							<label class="col-sm-1 control-label">Phone</label>
							<div class="col-sm-2">
								<input type="text" placeholder="Ex.000000" class="form-control input-sm">
							</div>
