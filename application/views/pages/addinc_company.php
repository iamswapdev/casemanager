					...
					<div class="panel-body tab-panel">
						...
						<form id="addInsuranceInfo" action="add_InsuranceInfo" method="post" class="form-horizontal">
							...
							<div class="form-group form-horizontal col-sm-12">
								...
								<label class="col-sm-1 control-label insurance-label">State <span class="required-field">*</span></label>
								<div class="col-sm-1">
								...
								<label class="col-sm-1 control-label insurance-label">City <span class="required-field">*</span></label>
								<div class="col-sm-2 insurance-input">
							...
							<div class="form-group form-horizontal col-sm-12">
								...
								<label class="col-sm-1 control-label insurance-label">Fax</label>
								<div class="col-sm-1">
			...
			function (isConfirm) 
				...
				if (isConfirm) {
					$.ajax({
						...
						type: "post",
						data: {Column_Name: "InsuranceCompany_Id", Table_Name: "dbo_tblinsurancecompany", Id: insuranceId},
						success: function(){
